...
export type GazeStatusView = { revision: number, state: string, cameraId: string | null, cameraName: string | null, calibrated: boolean, calibratedDisplayIds: Array<string>, calibrationSamples: number, capturedFrames: number, inferredFrames: number, detectedFrames: number, identityFrames: number, trackedFrames: number, droppedFrames: number, inferenceMs: number | null, faceConfidence: number | null, presenceState: string, presenceFaceCount: number, presenceOwnerSimilarity: number | null, presenceStableForMs: number, presenceProfileName: string | null, presenceProfileEnrolled: boolean, presenceEnrollmentActive: boolean, presenceEnrollmentSamples: number, presenceEnrollmentRequiredSamples: number, presenceEnrollmentRejectedFrames: number, presenceEnrollmentPose: string | null, observation: GazeObservationView | null, target: GazeTargetView | null, error: string | null, modelPack: GazeModelPackStatusView, };
...
export type PrivacySettings = { autoEnableOnMirror: boolean, autoEnableOnUntrustedPresence: boolean, allowRemoteActions: boolean, maskStyle: MaskStyle, protectedApps: Array<ProtectedApp>, };
