...
LangString deleteAppData ${LANG_SPANISH} "Borrar ajustes, dispositivos vinculados e historial"
LangString arcrelaySettingsTitle ${LANG_SPANISH} "Instalar ArcRelay"
LangString arcrelaySettingsSubtitle ${LANG_SPANISH} "1 / 3"
LangString arcrelayUpgradeSubtitle ${LANG_SPANISH} "$ArcRelayPreviousVersion → ${VERSION} · Datos conservados"
LangString arcrelayInstallIntro ${LANG_SPANISH} "Instalar para esta cuenta."
LangString arcrelayInstallButton ${LANG_SPANISH} "Instalar"
LangString arcrelayProgressTitle ${LANG_SPANISH} "Instalando…"
LangString arcrelayProgressSubtitle ${LANG_SPANISH} "2 / 3"
LangString arcrelayFinishTitle ${LANG_SPANISH} "Todo listo"
LangString arcrelayFinishText ${LANG_SPANISH} "3 / 3$\r$\n$\r$\nAbre ArcRelay para conectar tus dispositivos."
