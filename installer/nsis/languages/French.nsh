...
LangString deleteAppData ${LANG_FRENCH} "Supprimer réglages, appareils associés et historique"
LangString arcrelaySettingsTitle ${LANG_FRENCH} "Installer ArcRelay"
LangString arcrelaySettingsSubtitle ${LANG_FRENCH} "1 / 3"
LangString arcrelayUpgradeSubtitle ${LANG_FRENCH} "$ArcRelayPreviousVersion → ${VERSION} · Données conservées"
LangString arcrelayInstallIntro ${LANG_FRENCH} "Installer pour ce compte."
LangString arcrelayInstallButton ${LANG_FRENCH} "Installer"
LangString arcrelayProgressTitle ${LANG_FRENCH} "Installation…"
LangString arcrelayProgressSubtitle ${LANG_FRENCH} "2 / 3"
LangString arcrelayFinishTitle ${LANG_FRENCH} "Prêt à connecter"
LangString arcrelayFinishText ${LANG_FRENCH} "3 / 3$\r$\n$\r$\nOuvrez ArcRelay pour connecter vos appareils."
