...
LangString deleteAppData ${LANG_KOREAN} "설정, 페어링 및 기록 삭제 (복구 불가)"
LangString arcrelaySettingsTitle ${LANG_KOREAN} "ArcRelay 설치"
LangString arcrelaySettingsSubtitle ${LANG_KOREAN} "1 / 3"
LangString arcrelayUpgradeSubtitle ${LANG_KOREAN} "$ArcRelayPreviousVersion → ${VERSION} · 데이터 유지"
LangString arcrelayInstallIntro ${LANG_KOREAN} "현재 계정에 설치합니다."
LangString arcrelayInstallButton ${LANG_KOREAN} "설치"
LangString arcrelayProgressTitle ${LANG_KOREAN} "설치 중…"
LangString arcrelayProgressSubtitle ${LANG_KOREAN} "2 / 3"
LangString arcrelayFinishTitle ${LANG_KOREAN} "연결 준비 완료"
LangString arcrelayFinishText ${LANG_KOREAN} "3 / 3$\r$\n$\r$\nArcRelay를 열고 기기를 연결하세요."
