...
LangString deleteAppData ${LANG_PORTUGUESEBR} "Excluir configurações, pareamentos e histórico"
LangString arcrelaySettingsTitle ${LANG_PORTUGUESEBR} "Instalar ArcRelay"
LangString arcrelaySettingsSubtitle ${LANG_PORTUGUESEBR} "1 / 3"
LangString arcrelayUpgradeSubtitle ${LANG_PORTUGUESEBR} "$ArcRelayPreviousVersion → ${VERSION} · Dados preservados"
LangString arcrelayInstallIntro ${LANG_PORTUGUESEBR} "Instalar para esta conta."
LangString arcrelayInstallButton ${LANG_PORTUGUESEBR} "Instalar"
LangString arcrelayProgressTitle ${LANG_PORTUGUESEBR} "Instalando…"
LangString arcrelayProgressSubtitle ${LANG_PORTUGUESEBR} "2 / 3"
LangString arcrelayFinishTitle ${LANG_PORTUGUESEBR} "Tudo pronto"
LangString arcrelayFinishText ${LANG_PORTUGUESEBR} "3 / 3$\r$\n$\r$\nAbra o ArcRelay para conectar seus dispositivos."
