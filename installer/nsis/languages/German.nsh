...
LangString older ${LANG_GERMAN} "älter"
...
LangString deleteAppData ${LANG_GERMAN} "Einstellungen, Kopplungen und Verlauf endgültig löschen"
LangString arcrelaySettingsTitle ${LANG_GERMAN} "ArcRelay installieren"
LangString arcrelaySettingsSubtitle ${LANG_GERMAN} "1 / 3"
LangString arcrelayUpgradeSubtitle ${LANG_GERMAN} "$ArcRelayPreviousVersion → ${VERSION} · Daten bleiben erhalten"
LangString arcrelayInstallIntro ${LANG_GERMAN} "Für dieses Benutzerkonto installieren."
LangString arcrelayInstallButton ${LANG_GERMAN} "Installieren"
LangString arcrelayProgressTitle ${LANG_GERMAN} "Wird installiert…"
LangString arcrelayProgressSubtitle ${LANG_GERMAN} "2 / 3"
LangString arcrelayFinishTitle ${LANG_GERMAN} "Bereit zum Verbinden"
LangString arcrelayFinishText ${LANG_GERMAN} "3 / 3$\r$\n$\r$\nArcRelay öffnen und Geräte verbinden."
